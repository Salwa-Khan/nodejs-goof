...
exports.loginHandler = function (req, res, next) {
  // 1. Force the inputs to be strings. 
  // If req.body.username is an object like {$gt: ""}, String() turns it into "[object Object]"
  const username = String(req.body.username);
  const password = String(req.body.password);

  if (validator.isEmail(username)) {
    // 2. Use the forced string variables in the query instead of req.body directly
